...
localparam
    ...
    ADDR_IN_V_CTRL       = 7'h14,
    ADDR_WEIGHT_V_DATA_0 = 7'h18,
    ADDR_WEIGHT_V_CTRL   = 7'h1c,
    ADDR_BIAS_V_DATA_0   = 7'h20,
    ADDR_BIAS_V_CTRL     = 7'h24,
    ADDR_OUT_V_DATA_0    = 7'h28,
    ADDR_OUT_V_CTRL      = 7'h2c,
    ADDR_CH_IN_DATA_0    = 7'h30,
    ADDR_CH_IN_CTRL      = 7'h34,
    ADDR_CH_OUT_DATA_0   = 7'h38,
    ADDR_CH_OUT_CTRL     = 7'h3c,
    ADDR_SIZE_DATA_0     = 7'h40,
    ADDR_SIZE_CTRL       = 7'h44,
    ADDR_POOL_DATA_0     = 7'h48,
    ADDR_POOL_CTRL       = 7'h4c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_POOL_DATA_0)
            int_pool[31:0] <= (WDATA[31:0] & wmask) | (int_pool[31:0] & ~wmask);
    end
end
