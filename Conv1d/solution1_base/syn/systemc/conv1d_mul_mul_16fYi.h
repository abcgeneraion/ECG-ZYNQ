...
// ==============================================================
#ifndef __conv1d_mul_mul_16fYi__HH__
#define __conv1d_mul_mul_16fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv1d_mul_mul_16fYi) {
    ...
    SC_CTOR(conv1d_mul_mul_16fYi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
