...
set ID 656
set hasByteEnable 0
set MemName conv1d_buff_out1_ocq
...
set ID 657
set hasByteEnable 0
set MemName conv1d_bias_buff_UhA
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 64
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 658 \
			corename conv1d_CTRL_axilite \
			name conv1d_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv1d_CTRL_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv1d_IN_r_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv1d_W_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv1d_B_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv1d_OUT_r_m_axi
}
