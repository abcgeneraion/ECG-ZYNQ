...
//------------------------Parameter----------------------
`define TV_IN_W "./c.fc.autotvin_W.dat"
`define TV_OUT_W "./rtl.fc.autotvout_W.dat"
 parameter W_ADDR_BITWIDTH = 32'd 32;
 parameter W_AWUSER_BITWIDTH = 32'd 1;
 parameter W_DATA_BITWIDTH = 32'd 32;
 parameter W_WUSER_BITWIDTH = 32'd 1;
 parameter W_ID_BITWIDTH = 32'd 1;
 parameter W_RUSER_BITWIDTH = 32'd 1;
 parameter W_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter W_C_DATA_BITWIDTH = 32'd 16;
parameter W_mem_depth = 32'd 100;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_W_AWVALID;
output  TRAN_W_AWREADY;
input [W_ADDR_BITWIDTH - 1 : 0] TRAN_W_AWADDR;
input [W_ID_BITWIDTH - 1 : 0] TRAN_W_AWID;
input [8 - 1 : 0] TRAN_W_AWLEN;
input [3 - 1 : 0] TRAN_W_AWSIZE;
input [2 - 1 : 0] TRAN_W_AWBURST;
input [2 - 1 : 0] TRAN_W_AWLOCK;
input [4 - 1 : 0] TRAN_W_AWCACHE;
input [3 - 1 : 0] TRAN_W_AWPROT;
input [4 - 1 : 0] TRAN_W_AWQOS;
input [4 - 1 : 0] TRAN_W_AWREGION;
input [W_AWUSER_BITWIDTH - 1 : 0] TRAN_W_AWUSER;
input  TRAN_W_WVALID;
output  TRAN_W_WREADY;
input [W_DATA_BITWIDTH - 1 : 0] TRAN_W_WDATA;
input [W_DATA_BITWIDTH/8 - 1 : 0] TRAN_W_WSTRB;
input  TRAN_W_WLAST;
input  TRAN_W_WID;
input [W_WUSER_BITWIDTH - 1 : 0] TRAN_W_WUSER;
input  TRAN_W_ARVALID;
output  TRAN_W_ARREADY;
input [W_ADDR_BITWIDTH - 1 : 0] TRAN_W_ARADDR;
input [W_ID_BITWIDTH - 1 : 0] TRAN_W_ARID;
input [8 - 1 : 0] TRAN_W_ARLEN;
input [3 - 1 : 0] TRAN_W_ARSIZE;
input [2 - 1 : 0] TRAN_W_ARBURST;
input [2 - 1 : 0] TRAN_W_ARLOCK;
input [4 - 1 : 0] TRAN_W_ARCACHE;
input [3 - 1 : 0] TRAN_W_ARPROT;
input [4 - 1 : 0] TRAN_W_ARQOS;
input [4 - 1 : 0] TRAN_W_ARREGION;
input  TRAN_W_ARUSER;
output  TRAN_W_RVALID;
input  TRAN_W_RREADY;
output [W_DATA_BITWIDTH - 1 : 0] TRAN_W_RDATA;
output  TRAN_W_RLAST;
output [W_ID_BITWIDTH - 1 : 0] TRAN_W_RID;
output [W_RUSER_BITWIDTH - 1 : 0] TRAN_W_RUSER;
output [2 - 1 : 0] TRAN_W_RRESP;
output  TRAN_W_BVALID;
input  TRAN_W_BREADY;
output [2 - 1 : 0] TRAN_W_BRESP;
output [W_ID_BITWIDTH - 1 : 0] TRAN_W_BID;
output [W_BUSER_BITWIDTH - 1 : 0] TRAN_W_BUSER;
output [32 - 1 : 0] TRAN_W_weight_V;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [W_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [W_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [W_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [W_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [W_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [W_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [W_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] weight_V = 0;
reg [W_DATA_BITWIDTH - 1 : 0] W_mem_0 [0: W_mem_depth - 1]; 
reg [W_DATA_BITWIDTH - 1 : 0] W_mem_1 [0: W_mem_depth - 1]; 
reg [W_DATA_BITWIDTH - 1 : 0] W_mem_2 [0: W_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [W_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [W_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [W_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_W_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_W_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_W_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_W_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_W_BRESP = BRESP_tmp;
assign TRAN_W_RDATA = RDATA_tmp;
assign TRAN_W_RRESP = RRESP_tmp;
assign TRAN_W_RLAST = RLAST_tmp;
assign TRAN_W_RVALID = RVALID_tmp;
assign    TRAN_W_weight_V = weight_V;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = W_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  weight_V <= 0 * DATA_byte_num;
end

initial begin : initialize_W_mem
  integer i;
  for (i = 0; i < W_mem_depth; i = i + 1) begin
      W_mem_0[i] = 0;
      W_mem_1[i] = 0;
      W_mem_2[i] = 0;
  end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_W_AWREADY & TRAN_W_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_W_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_W_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_W_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_W_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_W_ARREADY & TRAN_W_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_W_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_W_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_W_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_W_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_W_WREADY & TRAN_W_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_W_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_W_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_W_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_W_AWVALID && TRAN_W_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_W_ARVALID && TRAN_W_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_W_WVALID && TRAN_W_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_W_WVALID && TRAN_W_WREADY && TRAN_W_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_W_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_W_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [W_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [W_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [W_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > W_mem_depth) begin
                $display ("C:/Users/Epoch/Desktop/FC/solution2/sim/verilog/AESL_axi_master_W.v: Write request address %d exceed AXI master W array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, W_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = W_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = W_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = W_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : W_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : W_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : W_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = W_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = W_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = W_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : W_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : W_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : W_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > W_mem_depth) begin
                $display ("C:/Users/Epoch/Desktop/FC/solution2/sim/verilog/AESL_axi_master_W.v: Read request address %d exceed AXI master W array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, W_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= W_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= W_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= W_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_W_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= W_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= W_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= W_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [W_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [W_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  W_bitwidth = W_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (W_bitwidth , factor);
  fp = $fopen(`TV_IN_W,"r"); 
      ...
      for(i = 0; i < 100 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : W_mem_0[i/factor] = mem_tmp;
                      1 : W_mem_1[i/factor] = mem_tmp;
                      2 : W_mem_2[i/factor] = mem_tmp;
