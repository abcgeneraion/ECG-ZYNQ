...
//------------------------Parameter----------------------
`define TV_IN_OUT_r "./c.fc.autotvin_OUT_r.dat"
`define TV_OUT_OUT_r "./rtl.fc.autotvout_OUT_r.dat"
 parameter OUT_r_ADDR_BITWIDTH = 32'd 32;
...
parameter OUT_r_C_DATA_BITWIDTH = 32'd 16;
parameter OUT_r_mem_depth = 32'd 100;
...
output [32 - 1 : 0] TRAN_OUT_r_out_V;
input ready;
input done;
...
reg RVALID_tmp = 0;
reg [32 - 1 : 0] out_V = 0;
reg [OUT_r_DATA_BITWIDTH - 1 : 0] OUT_r_mem_0 [0: OUT_r_mem_depth - 1]; 
reg [OUT_r_DATA_BITWIDTH - 1 : 0] OUT_r_mem_1 [0: OUT_r_mem_depth - 1]; 
reg [OUT_r_DATA_BITWIDTH - 1 : 0] OUT_r_mem_2 [0: OUT_r_mem_depth - 1]; 
...
initial begin : initialize_offset
  ...
  out_V <= 0 * DATA_byte_num;
end

initial begin : initialize_OUT_r_mem
  integer i;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > OUT_r_mem_depth) begin
                $display ("C:/Users/Epoch/Desktop/FC/solution2/sim/verilog/AESL_axi_master_OUT_r.v: Write request address %d exceed AXI master OUT_r array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, OUT_r_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > OUT_r_mem_depth) begin
                $display ("C:/Users/Epoch/Desktop/FC/solution2/sim/verilog/AESL_axi_master_OUT_r.v: Read request address %d exceed AXI master OUT_r array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, OUT_r_mem_depth); 
                $finish;
            end
...
initial begin : read_file_process 
  ...
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [OUT_r_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer OUT_r_bitwidth; 
  reg [OUT_r_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [OUT_r_DATA_BITWIDTH - 1 : 0] tmp_data;
  transaction_num = 0; 
  OUT_r_bitwidth = OUT_r_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (OUT_r_bitwidth , factor);
  while(1) begin 
      ...
      for(i = 0; i < (OUT_r_mem_depth - OUT_r_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = OUT_r_mem_0[i/factor];
                  1 : tmp_data = OUT_r_mem_1[i/factor];
                  2 : tmp_data = OUT_r_mem_2[i/factor];
          ...
          if (factor == 1) begin
              case(mem_page)
                  0 : mem_tmp = OUT_r_mem_0[i];
                  1 : mem_tmp = OUT_r_mem_1[i];
                  2 : mem_tmp = OUT_r_mem_2[i];
                  default: $display("The page_num of write file is not valid!");
              endcase
              $fdisplay(fp,"0x%x",mem_tmp);
          end
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = OUT_r_mem_0[OUT_r_mem_depth/factor];
              1 : tmp_data = OUT_r_mem_1[OUT_r_mem_depth/factor];
              2 : tmp_data = OUT_r_mem_2[OUT_r_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((OUT_r_mem_depth - 1) % factor == 2) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
              $fdisplay(fp,"0x%x",tmp_data[23:16]);
          end
          if ((OUT_r_mem_depth - 1) % factor == 1) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
          end
          if ((OUT_r_mem_depth - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
          end
      end
      if (factor == 2) begin
          if ((OUT_r_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : $fdisplay(fp,"0x%x",OUT_r_mem_0[OUT_r_mem_depth/factor][15:0]);
                  1 : $fdisplay(fp,"0x%x",OUT_r_mem_1[OUT_r_mem_depth/factor][15:0]);
                  2 : $fdisplay(fp,"0x%x",OUT_r_mem_2[OUT_r_mem_depth/factor][15:0]);
                  default: $display("The page_num of write file is not valid!");
              endcase
          end
      end
