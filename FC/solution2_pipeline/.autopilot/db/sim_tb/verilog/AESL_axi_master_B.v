...
//------------------------Parameter----------------------
`define TV_IN_B "./c.fc.autotvin_B.dat"
`define TV_OUT_B "./rtl.fc.autotvout_B.dat"
 parameter B_ADDR_BITWIDTH = 32'd 32;
...
parameter B_C_DATA_BITWIDTH = 32'd 16;
parameter B_mem_depth = 32'd 100;
...
reg RVALID_tmp = 0;
reg [32 - 1 : 0] bias_V = 0;
reg [B_DATA_BITWIDTH - 1 : 0] B_mem_0 [0: B_mem_depth - 1]; 
reg [B_DATA_BITWIDTH - 1 : 0] B_mem_1 [0: B_mem_depth - 1]; 
reg [B_DATA_BITWIDTH - 1 : 0] B_mem_2 [0: B_mem_depth - 1]; 
...
initial begin : initialize_offset
  ...
  bias_V <= 0 * DATA_byte_num;
end

initial begin : initialize_B_mem
  integer i;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > B_mem_depth) begin
                $display ("C:/Users/Epoch/Desktop/FC/solution2/sim/verilog/AESL_axi_master_B.v: Write request address %d exceed AXI master B array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, B_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > B_mem_depth) begin
                $display ("C:/Users/Epoch/Desktop/FC/solution2/sim/verilog/AESL_axi_master_B.v: Read request address %d exceed AXI master B array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, B_mem_depth); 
                $finish;
            end
...
initial begin : read_file_process 
  ...
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [B_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
