...
// ==============================================================
#ifndef __fc_mul_mul_16s_16bkb__HH__
#define __fc_mul_mul_16s_16bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fc_mul_mul_16s_16bkb) {
    ...
    SC_CTOR(fc_mul_mul_16s_16bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
